...
由于`yumemi`模块会越来越多，部分功能仅供测试使用，修改参数仅`管理`或`Master`可触发

> 例如修改群内 setu 模块参数`> update setu r18 1`
...
- 举个栗子
  + `设置公会 bl`，默认参数为 `none` ，可选 `bl`、`tw`、`jp`
- 正则公式
  + `^设置公会[\s]?(bl|tw|jp)`
...
- 补充说明
  + 发送指令后会自动记录当月时间，无需手动关闭，下期会战到来之际发起的会战请求即可
