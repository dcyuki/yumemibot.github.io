...
![查刀](../public/images/demo/selectFight.png)
![数据修正](../public/images/demo/update.png)

#### 出刀代报
- 举个栗子
  + `@xxx 代报 100000`可以为群成员代报出刀，若斩杀 boss ，不输入数值默认尾刀
- 补充说明

![代报](../public/images/demo/acting.png)
...
- 举个栗子
  + 每10分钟自动同步 bilibili 账号动态并转发
- 补充说明
  + 插件默认监听国服官方账号，可修改 uid 自定义，甚至可以实现直播监听推送
